...
If the resources are provided in an external API package an specific module is provided: _oas-generator-schema_.
...
Die *OAS Generator* makes no difference wich of the following validation api depdencyies is used:
